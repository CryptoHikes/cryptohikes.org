  ...
  return (
    <div>
      <header className="text-center py-10 bg-dark">
        <h1 className="text-4xl font-bold text-title pulsate">CryptoHikes</h1>
        <p className="mt-4 text-subtitle font-bold">Connect with the true nature of cryptocurrency.</p>
      </header>
      <section className="p-10">
        <h2 className="text-2xl font-bold text-section-heading">Featured Hikes</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
          {hikes.map((hike) => (
            <div key={hike.id} className="border-2 border-neon-pink p-4 rounded-lg shadow-lg bg-card card-hover-border transition duration-300">
      ...
      <section className="p-10">
        <h2 className="text-2xl font-bold text-section-heading">Upcoming Workshops</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
          {workshops.map((workshop) => (
            <div key={workshop.id} className="border-2 border-neon-purple p-4 rounded-lg shadow-lg bg-card card-hover-border transition duration-300">
